...
# expand horizontal bounds to allow sand to pile up and exit
rock_min_x -= 3
rock_max_x += 3
#rock_max_y += 3
...
sand_came_to_rest = True

sand_count = 0

# sand enters at (500,0)
while sand_came_to_rest:
	sand_x = 500
	sand_y = 0

	while True:
		# check that the sand hasn't fallen into the void
		if sand_y >= rock_max_y:
			sand_came_to_rest = False
			break
